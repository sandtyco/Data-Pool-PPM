...
<html lang="en">
	...
	<div class="container">
		...
		<div class="container">
			...
			<div>
				<h1 align="center">LAPORAN DATA PENGABDIAN MASYARAKAT</h1>
			...
			<br>
			<div class="row-fluid"><!--Jumlah Abdimas Tahunan-->
				<div class="span4">
					<?php
					// Menghubungkan dengan koneksi database
					include 'adm/conn.php';
					...
					$sql = "SELECT * FROM abdimas WHERE program = 'Hibah Amikom'";
				...
				<div class="span4">
					...
					// Perbaikan sintaksis SQL dan penanganan kesalahan
					$sql = "SELECT * FROM abdimas WHERE program = 'Pengabdian Kepada Masyarakat Kompetitif Nasional'";
					$data_user = mysqli_query($conn, $sql);
				...
				<div class="span4">
					...
					// Perbaikan sintaksis SQL dan penanganan kesalahan
					$sql = "SELECT * FROM abdimas WHERE program = 'Mandiri'";
					$data_user = mysqli_query($conn, $sql);
