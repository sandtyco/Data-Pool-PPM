		...
		<div class="container">
			<div class="nav nav-header">
				<ul class="breadcrumb">
					...
					<li class="active">Sentra HKI & Paten</li>
				</ul>
			</div>
			<div class="container">
				<h1 align="center">LAPORAN LUARAN HASIL SENTRA KI & PATEN</h1>
			...
			<div class="row-fluid">
				...
				<div class="span4">
					...
					$status_target = "Hak Cipta";
					// query untuk menghitung jumlah data dengan kategori tertentu
					$sql = "SELECT COUNT(*) AS jumlah FROM ki WHERE kategori = '$status_target'";
					...
					<div class="card well">
						<div class="card-body" style="background-color:#fff;">
							<h4><i class="icon-star"></i> <?php echo $status_target; ?></h4><hr>
							<p align="right">Jumlah: <b><?php echo $jumlah_status; ?></b></p>
						</div>
					</div>
				</div>
				<div class="span4">
			...
			<div class="row-fluid">
				<div class="span3"><!--Status-->
					...
					include 'adm/conn.php';
					// nilai jurusan yang ingin dihitung
					$status_target = "Granted";
					// query untuk menghitung jumlah data dengan status tertentu
					$sql = "SELECT COUNT(*) AS jumlah FROM ki WHERE status = '$status_target'";
					$result = mysqli_query($conn, $sql);
					// ambil hasil query
					$row = mysqli_fetch_assoc($result);
					$jumlah_status = $row['jumlah'];
					...
					<div class="card well">
						<div class="card-body" style="background-color:#fff;">
							<h4><i class="icon-star"></i> <?php echo $status_target; ?></h4><hr>
							<p align="right">Status Granted berjumlah: <b><?php echo $jumlah_status; ?></b></p>
						</div>
					</div>
				</div><!--/span-->
				<div class="span3"><!--Status-->
					...
					<div class="card well">
						<div class="card-body" style="background-color:#fff;">
							<h4><i class="icon-star"></i> <?php echo $status_target; ?></h4><hr>
							<p align="right">Status Terbit berjumlah: <b><?php echo $jumlah_status; ?></b></p>
						</div>
					</div>
				</div><!--/span-->
				<div class="span3"><!--Status-->
					...
					<div class="card well">
						<div class="card-body" style="background-color:#fff;">
							<h4><i class="icon-star"></i> <?php echo $status_target; ?></h4><hr>
							<p align="right">Status Terdaftar berjumlah: <b><?php echo $jumlah_status; ?></b></p>
						</div>
					</div>
				</div><!--/span-->
				<div class="span3"><!--Status-->
					...
					<div class="card well">
						<div class="card-body" style="background-color:#fff;">
							<h4><i class="icon-star"></i> <?php echo $status_target; ?></h4><hr>
							<p align="right">Status Diterima berjumlah: <b><?php echo $jumlah_status; ?></b></p>
						</div>
					</div>
				</div><!--/span-->
			</div>
			...
			<div class="card-body">
				<table class="table table-hover" id="myData">
					...
					?>
						<tr>
							<td><?php echo $no++; ?></td>
							<td><a href="https://pdki-indonesia.dgip.go.id/" target="_blank"><?php echo $d['reg']; ?></a></td>
							<td><?php echo $d['no_pub']; ?></td>
							<td>
								<ul style="list-style: none;">
									<li><p><a href="https://pdki-indonesia.dgip.go.id/" target="_blank"><?php echo $d['title']; ?></a></p></li>
									<li><p>Status & Tipe: <b><?php echo $d['status']; ?></b> - <b><?php echo $d['kategori']; ?></b></p></li>
									<li><p>Tahun: <b><?php echo $d['year']; ?></b></p></li>
								</ul>
							</td>
							<td>
								<ul style="list-style: none;">
									<li><p>Pemegang Hak: <br><?php echo $d['holder']; ?></p></li>
									<li><p>Inventor: <br><?php echo $d['inventor']; ?></p></li>
								</ul>
							</td>
						</tr>
						<?php
