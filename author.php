...
<html lang="en">
	...
	<div class="container">
		...
		<div class="container">
			...
			<div>
				<h2 align="center">Data Author Lingkungan Universitas Amikom Purwokerto</h2>
				<h4 align="center">Update Data Terakhir Pada Tahun <b>2024</b></h4><hr>
				<!-- Statistik Author -->
				<div class="row-fluid">
					<div class="span4"><!--Jumlah Author-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// mengambil data
						$data_user = mysqli_query($conn,"SELECT * FROM author");
						// menghitung data barang
						$jumlah_user = mysqli_num_rows($data_user);
						?>
						<div class="card well">
							<div class="card-body" style="background-color:#fff;">
								<h4><i class="icon-user"></i> Jumlah Author</h4><hr>
								<h3 align="right"><?php echo $jumlah_user; ?></h3><!--kode php jumlah count data-->
							</div>
					...
					<div class="span4"><!--Tenaga Pengajar-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jafung yang ingin dihitung
						$jafung_target = "Tenaga Pengajar";
						// query untuk menghitung jumlah data dengan jafung tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jafung = '$jafung_target'";
						$result = mysqli_query($conn, $sql);
						// ambil hasil query
						$row = mysqli_fetch_assoc($result);
						$jumlah_jafung = $row['jumlah'];
						?>
						<div class="card well">
							<div class="card-body" style="background-color:#fff;">
								<h4><i class="icon-bookmark"></i> <?php echo $jafung_target; ?></h4><hr>
								<h3 align="right"><?php echo $jumlah_jafung; ?></h3>
							</div>
							<div class="card-footer d-flex align-items-center justify-content-between">
								<div class="small text-white"><i class="glyphicon glyphicon-eye-open"></i></div>
							</div>
					...
					<div class="span4"><!--Asisten Ahli-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jafung yang ingin dihitung
						$jafung_target = "Asisten Ahli";
						// query untuk menghitung jumlah data dengan jafung tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jafung = '$jafung_target'";
						$result = mysqli_query($conn, $sql);
						// ambil hasil query
						...
						<div class="card well">
							<div class="card-body" style="background-color:#fff;">
								<h4><i class="icon-cog"></i> <?php echo $jafung_target; ?></h4><hr>
								<h3 align="right"><?php echo $jumlah_jafung; ?></h3>
							</div>
							<div class="card-footer d-flex align-items-center justify-content-between">
								<div class="small text-white"><i class="glyphicon glyphicon-eye-open"></i></div>
				...
				<div class="row-fluid">
					<div class="span4"><!--Lektor-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jafung yang ingin dihitung
						$jafung_target = "Lektor";
						// query untuk menghitung jumlah data dengan jafung tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jafung = '$jafung_target'";
						$result = mysqli_query($conn, $sql);
						// ambil hasil query
						...
						<div class="card well">
							<div class="card-body" style="background-color:#fff;">
								<h4><i class="icon-certificate"></i> <?php echo $jafung_target; ?></h4><hr>
								<h3 align="right"><?php echo $jumlah_jafung; ?></h3>
							</div>
							<div class="card-footer d-flex align-items-center justify-content-between">
								<div class="small text-white"><i class="glyphicon glyphicon-eye-open"></i></div>
					...
					<div class="span4"><!--Lektor Kepala-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jafung yang ingin dihitung
						$jafung_target = "Lektor Kepala";
						// query untuk menghitung jumlah data dengan jafung tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jafung = '$jafung_target'";
						$result = mysqli_query($conn, $sql);
						// ambil hasil query
						...
						<div class="card well">
							<div class="card-body" style="background-color:#fff;">
								<h4><i class="icon-star-empty"></i> <?php echo $jafung_target; ?></h4><hr>
								<h3 align="right"><?php echo $jumlah_jafung; ?></h3>
							</div>
							<div class="card-footer d-flex align-items-center justify-content-between">
								<div class="small text-white"><i class="glyphicon glyphicon-eye-open"></i></div>
					...
					<div class="span4"><!--Guru Besar-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jafung yang ingin dihitung
						$jafung_target = "Guru Besar";
						// query untuk menghitung jumlah data dengan jafung tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jafung = '$jafung_target'";
						$result = mysqli_query($conn, $sql);
						// ambil hasil query
						...
						<div class="card well">
							<div class="card-body" style="background-color:#fff;">
								<h4><i class="icon-star"></i> <?php echo $jafung_target; ?></h4><hr>
								<h3 align="right"><?php echo $jumlah_jafung; ?></h3>
							</div>
							<div class="card-footer d-flex align-items-center justify-content-between">
								<div class="small text-white"><i class="glyphicon glyphicon-eye-open"></i></div>
					...
					<div class="card-body">
						<table class="table table-hover" id="myData">
							...
							$result = mysqli_query($conn, $sql);
								...
								<tr>
									<td><?php echo $no++; ?></td>
									<td><img src="<?php echo $d['url_img']; ?>" class="img-rounded thumbnail" width="100" height="50"></td>
									<td>
										<ul style="list-style: none;">
											<li>NIDN:</li>
											<li><a href="https://pddikti.kemdiktisaintek.go.id/search/<?php echo $d['nidn']; ?>" target="_blank"><b><?php echo $d['nidn']; ?></b></a></li>
											<li>NUPTK:</li>
											<li><a href="https://pddikti.kemdiktisaintek.go.id/search/<?php echo $d['nuptk']; ?>" target="_blank"><b><?php echo $d['nuptk']; ?></b></a></li>
										</ul>
									</td>
									<td>
										<ul style="list-style: none;">
											<li><b><?php echo $d['nama']; ?></b><br></li>
											<li><?php echo $d['jafung']; ?></li>
											<li><?php echo $d['pangkat']; ?></li>
											<li><?php echo $d['gol']; ?></li>
										</ul>
									</td>
									<td>
										<ul style="list-style: none;">
											<li><?php echo $d['departemen']; ?></li>
											<li><?php echo $d['jurusan']; ?></li>
											<li><?php echo $d['program']; ?></li>
											<li>Pusat Studi:<br><b><?php echo $d['ps']; ?></b></li>
										</ul>
									</td>
									<td>
										<ul style="list-style: none;">
											<li><a href="https://sinta.kemdikbud.go.id/authors/profile/<?php echo $d['id_sinta']; ?>" target="_blank"><img src="https://lppm.amikompurwokerto.ac.id/assets/upload/client/client-7.png" width="80"></a></li>
											<li><a href="https://www.scopus.com/authid/detail.uri?authorId=<?php echo $d['id_scopus']; ?>" target="_blank"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRV7WqqMSmkMUL9fqbTdmHgJL6opZra2YYnwQ&s" width="80"></a></li>
											<li><a href="https://scholar.google.com/citations?hl=id&user=<?php echo $d['id_scholar']; ?>" target="_blank"><img src="https://waqasalvi.com/wp-content/uploads/2022/11/google-scholar-png-1.png" width="80"></a></li>
										</ul>
									</td>
								</tr>
							<?php
