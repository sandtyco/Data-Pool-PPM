		...
		<div class="container">
			<div class="nav nav-header">
				<ul class="breadcrumb">
					...
					<li class="active">Afiliasi</li>
				</ul>
			</div>
			
			<div>
				<h2 align="center">Data Jumlah Afiliasi Author Universitas Amikom Purwokerto</h2>
				<h4 align="center">Update Data Terakhir Pada Tahun <b>2024</b></h4><hr>
				<!-- Statistik Author -->
				<h3><img src="adm/assets/img/aff.png" width="50"> Fakultas Ilmu Komputer</h3>
				<div class="row-fluid">
					<div class="span4"><!--Informatika-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jurusan yang ingin dihitung
						$jurusan_target = "Informatika";
						$level = "S1";
						// query untuk menghitung jumlah data dengan jurusan tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jurusan = '$jurusan_target'";
						...
						<div class="card well">
							<div class="card-body" style="background-color:#fff;">
								<h4><i class="icon-map-marker"></i> <?php echo $jurusan_target; ?> - <?php echo $level; ?></h4><hr>
								<p align="right">Terdapat <b><?php echo $jumlah_jurusan; ?></b> Author</p>
							</div>
						</div>
					</div><!--/span-->
					<div class="span4"><!--Sistem Informasi-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jurusan yang ingin dihitung
						$jurusan_target = "Sistem Informasi";
						$level = "S1";
						// query untuk menghitung jumlah data dengan jurusan tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jurusan = '$jurusan_target'";
						$result = mysqli_query($conn, $sql);
					...
					<div class="span4"><!--Teknologi Informasi-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jurusan yang ingin dihitung
						$jurusan_target = "Teknologi Informasi";
						$level = "S1";
						// query untuk menghitung jumlah data dengan jurusan tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jurusan = '$jurusan_target'";
						$result = mysqli_query($conn, $sql);
				...
				<h3><img src="adm/assets/img/aff.png" width="50"> Fakultas Bisnis Dan Ilmu Sosial</h3>
				<div class="row-fluid">
					<div class="span3"><!--Ilmu Komunikasi-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jurusan yang ingin dihitung
						$jurusan_target = "Ilmu Komunikasi";
						$level = "S1";
						// query untuk menghitung jumlah data dengan jurusan tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jurusan = '$jurusan_target'";
						$result = mysqli_query($conn, $sql);
					...
					<div class="span3"><!--Bisnis Digital-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jurusan yang ingin dihitung
						$jurusan_target = "Bisnis Digital";
						$level = "S1";
						// query untuk menghitung jumlah data dengan jurusan tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jurusan = '$jurusan_target'";
						$result = mysqli_query($conn, $sql);
				...
				<h3><img src="adm/assets/img/aff.png" width="50"> Fakultas Ilmu Kesehatan</h3>
				<div class="row-fluid">
					<div class="span3"><!--Kebidanan-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jurusan yang ingin dihitung
						$jurusan_target = "Kebidanan";
						$level = "D3";
						// query untuk menghitung jumlah data dengan jurusan tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jurusan = '$jurusan_target'";
						$result = mysqli_query($conn, $sql);
					...
					<div class="span3"><!--Fisioterapi-->
						<?php
						// menghubungkan dengan koneksi database
						include 'adm/conn.php';
						// nilai jurusan yang ingin dihitung
						$jurusan_target = "Fisioterapi";
						$level = "S1";
						// query untuk menghitung jumlah data dengan jurusan tertentu
						$sql = "SELECT COUNT(*) AS jumlah FROM author WHERE jurusan = '$jurusan_target'";
						$result = mysqli_query($conn, $sql);
				...
				<h3><img src="adm/assets/img/aff.png" width="50"> Pascasarjana</h3>
				<div class="row-fluid">
					<div class="span6">
						<?php
						// menghubungkan dengan koneksi database
						...
						<table class="table table-hover" id="myData">
							...
							$result = mysqli_query($conn, $sql);
								...
								<tr>
									...
									<td><a href="<?php echo $d['url']; ?>" target="_blank"><?php echo $d['jurusan']; ?></a></td>
									<td><?php echo $d['program']; ?></td>
									<td><?php echo $d['deg']; ?></td>
								</tr>
							<?php
								}
								} else {
